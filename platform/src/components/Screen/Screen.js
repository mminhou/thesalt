                    ...
                    <Grid container style={{marginTop: 300, top: 0, left: 0, position: "absolute"}}>
                        ...
                        <Grid item xs={6}>
                            <div style={{paddingRight: '15%'}}>
                                <h1 className="title">THE SALT</h1>
                                <h1 className="subtitle">High Quality Select Shop</h1>
                ...
                <FullpageSection style={{backgroundColor: 'white', padding: '1em',}}>
                    <Grid container direction="row" justify="center" alignItems="center" style={{textAlign: "center"}}>
                        <Grid item xs={12}>
                            ...
                            <Typography variant="h4" className="introduce">CREATOR</Typography>
                            <img src={min} width='25%' className="avatar"/>
                            <Typography variant="h4" calssName="smallCaps">minho choi</Typography>
                            <Typography variant="h5" className="smallCaps">computer science</Typography>
                            <Typography variant="h5" className="info"><a href='https://github.com/mminhou/cntex'>https://github.com/mminhou/cntex</a></Typography>
