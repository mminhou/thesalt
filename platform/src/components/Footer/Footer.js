    ...
    return (
        <div class="site-footer">
            <Grid container style={{width: '80%', margin: "auto"}}>
                <Grid container direction="row">
                    ...
                    <Grid md={3} sm={6} xs={6}>
                        ...
                        <List>
                            <ListItem button style={{padding: 0, textAlign: 'right'}}><ListItemText
            ...
            <Divider variant="middle"
                     style={{width: '82%', margin: "auto", marginTop: 10, height: 1, backgroundColor: '#bbb'}}/>
            <Grid container style={{width: '80%', margin: "auto"}} alignItems="center">
                <Grid item md={8}>
                    <Typography variant="body1" align="left">Copyright &copy; 2021 All Rights Reserved by <a
                        href="#">CMM</a>.</Typography>
                </Grid>
                <Grid item md={4} sm={6} xs={12} alignItems="center" justify="center">
                    <ul className="social-icons">
                        <li><a className="facebook" href="https://www.facebook.com"><Facebook className="fa fa-facebook"
                                                                                              style={{height: '1.5rem !important'}}/></a>
                        </li>
                        <li><a className="instagram" href="https://www.instagram.com"><Instagram
                            className="fa-instagram"/></a></li>
                        <li><a className="twitter" href="https://twitter.com"><Twitter className="fa-twitter"/></a></li>
                        <li><a className="linkedin" href="https://kr.linkedin.com"><LinkedIn
                            className="fa-linkedin"></LinkedIn></a></li>
                    </ul>
                </Grid>
            </Grid>
        </div>
